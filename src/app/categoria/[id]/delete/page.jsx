...
<div>
        <div class="items-center justify-center h-screen mt-8">
            ...
            rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="popup-modal">
                ...
                <span href="/categoria" class="sr-only">Cerrar</span>
                {/* <a href="/categoria" >Cerrar</a> */}
            </button>
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Estás seguro de que deseas eliminar este categoria <span className="font-bold">{newCategoria.nombre}</span> ?</h3>
                ...
                <a href="/categoria" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 
