    ...
    return(
        <div>
            ...
            focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2
             ...
             dark:focus:ring-blue-800" href='/categoria/new'>Nueva Categoria</Link>
            ...
            <form>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        placeholder="Buscar Categorias por Descripcion, Fecha..."
                        required
                    />
                    <button
                        type="submit"
                    ...
                    <tbody>
                        {
                            categorias.map(categoria=>(
                                <CategoriaCard key={categoria._id} categoria={categoria} />
                            ))
                        }
                    </tbody>
                </table>
